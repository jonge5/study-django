    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, '거절'), (0, '대기'), (1, '승인')], default=0)),
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='receiver_set', to='member.member')),
                ('sander', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sender_set', to='member.member')),
            ],
            options={
                'db_table': 'tbl_friend',
            },
